...
func (this ScanningService) Scan(annotationType entities.AnnotationType,
	folderToScan string) {
	annotationsToRead := this.getAnnotationPaths(folderToScan)
	annotationsToGroup := this.readAnnotations(annotationType, annotationsToRead)
